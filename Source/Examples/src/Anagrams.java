...
/**
 * Compute the list of "<i>n</i>-anagrams" from a dictionary file. An <i>n</i>-anagram is a
 * set of letters that can be used to form <i>n</i> or more dictionary words.
 * This is a
 * slightly modified re-implementation of the
 * <a href="http://code.google.com/p/hadoop-map-reduce-examples/wiki/Anagram_Example">example provided by Hadoop</a>.
...
public class Anagrams
{
	...
	{
		int n = 8;
		InCollector<String,String> data = new WordCollector("SINGLE.TXT");
		SequentialWorkflow<String,String> w = new SequentialWorkflow<String,String>(new AnagramMap(), new AnagramReduce(n), data);
